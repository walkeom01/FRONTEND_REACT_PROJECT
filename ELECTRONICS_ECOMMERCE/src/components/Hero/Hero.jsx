              ...
              <div className="flex gap-2 mt-4 justify-center sm:justify-start">
                {HeroData.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full ml-5 ${
            ...
            <div className="order-1 sm:order-2">
              <div>
                <img
                  src={data.img}
                  alt=""
                  className="w-[500px] h-[500px] sm:h-[450px] sm:scale-105 mx-auto lg:scale-110 object-contain drop-shadow-[-8px_4px_6px_rgba(0,0,0,0.4)] hover:scale-105 transition-all duration-300"
                />
              </div>
            </div>
